...
router.get('/article/template/:slug', articleController.getArticleBySlugWithItsTemplate);

router.get('/templates/', articleController.getArticleTemplates);
router.get('/template/author/:id', articleController.getArticleAuthorWithItsTemplate);
